...
class Player extends SpriteAnimationComponent 
  ...
  final Vector2 _keyboardMoviment = Vector2.zero();
  ...
  void update(double dt){
    ...
    final Vector2 movement = game.joystick.relativeDelta + _keyboardMoviment;
